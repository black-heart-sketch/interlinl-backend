...
router.post('/reconcile-pending', authorize('superadmin'), paymentController.reconcilePendingPayments);
...
router.post('/internship/manual', authorize('admin', 'superadmin'), paymentController.recordManualInternshipPayment);
